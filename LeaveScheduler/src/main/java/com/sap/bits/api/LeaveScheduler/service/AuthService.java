...
import com.sap.bits.api.LeaveScheduler.repository.BlacklistTokenRepository;
...
public class AuthService {
    ...
    @Transactional
    public List<User> register(List<RegisterRequest> registerRequests) throws BadRequestException {
    ...
    public ApiResponse changePassword(PasswordChangeRequest passwordChangeRequest) throws BadRequestException {
    ...
    public void resetPassword(String token, String newPassword) throws BadRequestException {
